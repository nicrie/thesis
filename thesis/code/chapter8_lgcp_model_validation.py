...
save_to_raster = get_figure_path("chapter8", "raster", "lgcp_model_evaluation.png")
save_to_vector = get_figure_path("chapter8", "vector", "lgcp_model_evaluation.svg")
...
save_to_vector = get_figure_path("chapter8", "vector", "lgcp_model_trace_plots.svg")
save_to_raster = get_figure_path("chapter8", "raster", "lgcp_model_trace_plots.png")
plt.savefig(save_to_vector, bbox_inches="tight", dpi=300)
plt.savefig(save_to_raster, bbox_inches="tight", dpi=300)
plt.show()
