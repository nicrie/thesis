...
save_to_raster = get_figure_path("chapter5", "raster", "ospar_variance_seasonality.png")
save_to_vector = get_figure_path("chapter5", "vector", "ospar_variance_seasonality.svg")
