...
save_to_vector = get_figure_path("chapter5", "vector", "plastics_clusters_boxplot.svg")
save_to_raster = get_figure_path("chapter5", "raster", "plastics_clusters_boxplot.png")
